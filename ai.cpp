...
web::json::value move(const web::json::value &current_game_state) {
  ...
  auto remaining_number_of_turns = current_game_state.at(U("turns"));
  ...
  auto current_level_layout = current_game_state.at(U("layout"));

  // This is an array of all music items you've currently picked up
  auto picked_up_music_items = current_game_state.at(U("pickedUp"));

  // The position attribute tells you where your monkey is
  auto current_position_of_monkey = current_game_state.at(U("position"));
